package com.cibnvideo.jobservice.config.datasource;
...
public class DataSourceConfig {
    @Bean
    @Primary
    @ConfigurationProperties(prefix="spring.datasource.jobservice.master")
    public DataSource MasterDataSource() {
        return new DataSource();
    }

    @Bean
    @ConfigurationProperties(prefix="spring.datasource.jobservice.slave00")
