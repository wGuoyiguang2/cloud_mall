    ...
    $('#ordertb').bootstrapTreeTable(
            {
                ...
                url: '/v1/tcmalladmin/orderList', // 请求数据的ajax的url
                ajaxParams: params,
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row) {
                            if(value.parentId==0){
                                ...
                                if (1 == value.orderState) {
                                    return "待支付";
                                } else if (2 == value.orderState) {
                                    return "已取消";
                                } else if (3 == value.orderState) {
                                    return "待收货";
                                } else if (4 == value.orderState) {
                                    return "拒收";
                                } else if (5 == value.orderState) {
                                    return "已完成";
                                }
                            }
                        }
