...
public class JdSyncMasterDbAop {
    ...
    private Logger logger = LoggerFactory.getLogger("JdSyncMasterDbAop");

    @Pointcut("execution(public * com.cibnvideo.jdsync.dao.*.save*(..)) || " +
            "execution(public * com.cibnvideo.jdsync.dao.*.update*(..)) || " +
            "execution(public * com.cibnvideo.jdsync.dao.*.remove*(..)) || " +
            "execution(public * com.cibnvideo.jdsync.dao.*.batchRemove*(..))")
