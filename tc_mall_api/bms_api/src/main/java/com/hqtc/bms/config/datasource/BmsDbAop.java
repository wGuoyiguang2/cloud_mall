package com.hqtc.bms.config.datasource;
...
@Aspect
@Component
public class BmsDbAop {

    private Logger logger = LoggerFactory.getLogger("BmsDbAop");

    @Pointcut("execution(public * com.hqtc.bms.model.mapper.*.*(..))")
